  ...
  return (
    <div>
      <div className="text-center mt-20">
            ...
            Mark how much would you like to perform that task:
            </strong>
            </p>
        </div>
        ...
        <div className="block-center flex mt-10">
          <button className="btn previous ml-1 mr-40" onClick={handlePreviousClick}>
          ...
          <button className="btn next ml-40" onClick={handleNextClick}>
        ...
        {(completePercentage === 100) && (<button className="btn btn-success mt-10" onClick={handleSubmitClick}>Submit</button>)}
    </div>
  );
}
