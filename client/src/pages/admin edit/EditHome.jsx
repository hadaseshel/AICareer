...
export default function EditHomePage() {
    ...
    const [titleOfDescription, setTitleOfDescription] = useState("");
    const [text1OfDescription, setText1OfDescription] = useState("");
    const [text2OfDescription, setText2OfDescription] = useState("");
    const [text3OfDescription, setText3OfDescription] = useState("");
    ...
    useEffect(() => {
        ...
        getNumberOf(setNumberOfUsers,'/api/user/users');
    ...
    return(
        <div>
            <div className="mx-auto max-w-2xl py-5 sm:py-21 lg:py-27 text-center">
                ...
                <div className="mt-10 gap-x-6">
                    <div className="btn-group" role="group" aria-label="Basic mixed styles example">
                        <button type="button" className="btn btn-outline-dark" onClick={()=>updadeValues('/api/home', "description", titleOfDescription, "", text1OfDescription, "", text2OfDescription, "", text3OfDescription)} >Save changes</button>
                        <button type="button" className="btn btn-outline-dark" onClick={()=>restorValues(putSectionOfDescription,'/api/home', "description")}>Disregard changes</button>
                    </div>
                </div>
            </div>
            ...
            <div className="mx-auto max-w-2xl py-5 sm:py-21 lg:py-27 text-center">
                                ...
                                <div className="col">
                                    <div className="card h-100"> 
                                        <div className="card-body">
                                            <h2 className="card-title countNumber">
                                                {numberOfQuestions}
                                            </h2>
                ...
                <div className="mt-10 gap-x-6">
                    <div className="btn-group" role="group" aria-label="Basic mixed styles example">
                        <button type="button" className="btn btn-outline-dark" onClick={()=>updadeValues('/api/home', "numbers of app", titleOfNumbers, title1OfNumbers, text1OfNumbers, title2OfNumbers, text2OfNumbers, title3OfNumbers, text3OfNumbers)}>Save changes</button>
                        <button type="button" className="btn btn-outline-dark" onClick={()=>restorValues(putSectionOfNumbers,'/api/home', "numbers of app")}>Disregard changes</button>
                    </div>
                </div>
            </div>
            ...
            <div className="mx-auto max-w-2xl py-5 sm:py-21 lg:py-27 text-center">
                            ...
                            <div className="row mb-4">
                                <div className="col">
                                    <div className="card h-100"> 
                                        <div className="card-body">
                                            <h2 className="card-title countNumber">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" className="bi bi-pie-chart-fill" viewBox="0 0 16 16">
                                ...
                                <div className="col">
                                    <div className="card h-100"> 
                                        <div className="card-body">
                                            <h2 className="card-title countNumber">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" className="bi bi-wallet-fill" viewBox="0 0 16 16">
                                ...
                                <div className="col">
                                    <div className="card h-100"> 
                                        <div className="card-body">
                                            <h2 className="card-title countNumber">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" className="bi bi-door-open-fill" viewBox="0 0 16 16">
                ...
                <div className="mt-10 gap-x-6">
                    <div className="btn-group" role="group" aria-label="Basic mixed styles example">
                        <button type="button" className="btn btn-outline-dark" onClick={()=>updadeValues('/api/home', "market status", titleOfMarket, title1OfMarket, text1OfMarket, title2OfMarket, text2OfMarket, title3OfMarket, text3OfMarket)}>Save changes</button>
                        <button type="button" className="btn btn-outline-dark" onClick={()=>restorValues(putSectionOfMarket,'/api/home', "market status")}>Disregard changes</button>
                    </div>
                </div>
            </div>
        </div>
